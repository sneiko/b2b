...
{
    public partial class _0001_CreateModels : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "PriceColumnItem",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    PriceColumn = table.Column<int>(nullable: false),
                    Value = table.Column<string>(nullable: true),
                    HandlerId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PriceColumnItem", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PriceColumnItem_Handlers_HandlerId",
                        column: x => x.HandlerId,
                        principalTable: "Handlers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PriceColumnItem_HandlerId",
                table: "PriceColumnItem",
                column: "HandlerId");
