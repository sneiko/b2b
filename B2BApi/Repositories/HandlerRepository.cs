...
namespace B2BApi.Repositories {
    public class HandlerRepository : BaseRepository, IHandlerRepository {
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<List<Handler>> GetHandlerListAsync() => await Context.Handlers.ToListAsync();
        ...
        /// <returns></returns>
        public async Task UpdateHandler(Handler handler) => Context.Handlers.Update(handler);
        ...
        /// <param name="handler"></param>
        /// <returns></returns>
        public async Task AddHandler(Handler handler) => Context.Handlers.Add(handler);
    }
}